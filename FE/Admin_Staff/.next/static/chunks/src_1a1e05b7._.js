(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_1a1e05b7._.js", {
...
function RegisterVaccinationModal({ open, onClose }) {
    ...
    }["RegisterVaccinationModal.useStore"]) // Lấy danh sách parent
    ;
    const vaccines = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])({
        "RegisterVaccinationModal.useStore[vaccines]": (state)=>state.product.vaccines
    }["RegisterVaccinationModal.useStore[vaccines]"]);
    ...
    const [childProductMap, setChildProductMap] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [searchTerm, setSearchTerm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const filteredUsers = allUsers?.filter((user)=>user.fullname.toLowerCase().includes(searchTerm.toLowerCase()) || user.id.toString().includes(searchTerm)) || [];
    // Khi user chọn parent từ dropdown
    const handleSelectParent = async (val)=>{
        const parentId = Number(val);
        setSelectedParentId(parentId);
    };
    // Mỗi khi selectedParentId thay đổi, load chi tiết user (nếu cần) 
    // hoặc lấy trực tiếp từ allUsers. 
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RegisterVaccinationModal.useEffect": ()=>{
            if (selectedParentId) {
                // Giả sử ta tìm ngay trong allUsers
                const p = allUsers.find({
                    "RegisterVaccinationModal.useEffect.p": (u)=>u.id === selectedParentId
                }["RegisterVaccinationModal.useEffect.p"]);
                if (p) {
                    setSelectedParent(p);
                    // Tách firstName, lastName từ p.fullname (tuỳ logic)
                    const [fname, ...rest] = p.fullname.split(" ");
                    setFirstName(fname || "");
                    setLastName(rest.join(" ") || "");
                    setEmail(p.email || "");
                    setMobileNo(p.phone || "");
                    // Xây dựng childProductMap rỗng cho tất cả children
                    const initMap = {};
                    p.children?.forEach({
                        "RegisterVaccinationModal.useEffect": (child)=>{
                            initMap[child.childId] = [];
                        }
                    }["RegisterVaccinationModal.useEffect"]);
                    setChildProductMap(initMap);
                }
            } else {
                // reset
    ...
    // Xử lý khi check/ uncheck vaccine cho một đứa trẻ
    const handleVaccineCheck = (childId, vaccineId, checked)=>{
        setChildProductMap((prev)=>{
            const oldList = prev[childId] || [];
            let newList = [];
            if (checked) {
                // add vaccineId
                newList = [
                ...
                // remove vaccineId
                newList = oldList.filter((id)=>id !== vaccineId);
            }
            return {
                ...prev,
                [childId]: newList
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            const token = localStorage.getItem("token");
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axiosConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/order/create-by-product/", payload, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
            ...
            children: [
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$popover$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PopoverTrigger"], {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        children: [
                                            selectedParentId ? allUsers.find((user)=>user.id === selectedParentId)?.fullname : "Select parent...",
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Command, {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CommandGroup, {
                                                ...
                                                children: filteredUsers.map((user)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CommandItem, {
                                                        value: user.id.toString(),
                                                        onSelect: ()=>{
                                                            handleSelectParent(user.id.toString());
                                                        },
                                                        children: [
                                                            user.fullname,
                                                            " (ID: ",
                ...
                selectedParent && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "border rounded-md p-4 space-y-4 mb-4",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                selectedParent && Array.isArray(selectedParent.children) && selectedParent.children.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "space-y-4 mb-4",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                            className: "text-lg font-semibold",
                            children: "Select Vaccines for Children"
                        }, void 0, false, {
                            fileName: "[project]/src/components/modals/RegisterVaccinationModal.tsx",
                            lineNumber: 254,
                            columnNumber: 13
                        }, this),
                        selectedParent.children.map((child)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: vaccines?.map((v)=>{
                                            const checked = childProductMap[child.childId]?.includes(v.id) || false;
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$checkbox$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Checkbox"], {
                                                        ...
                                                        onCheckedChange: (checkedValue)=>{
                                                            handleVaccineCheck(child.childId, v.id, !!checkedValue);
                                                        }
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/modals/RegisterVaccinationModal.tsx",
                                                        lineNumber: 271,
...
_s(RegisterVaccinationModal, "eJ9QJbBtNdbfzBoiSe5PZIbAhrQ=", false, function() {
    return [
...
//# sourceMappingURL=src_1a1e05b7._.js.map