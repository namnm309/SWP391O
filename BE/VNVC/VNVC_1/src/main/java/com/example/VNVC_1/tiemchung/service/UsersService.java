...
public class UsersService {
    ...
    // 10. Quản lý rating, feedback (chỉ dành cho admin)
    public String manageRatingFeedback(Long userId, Object feedbackDetails) {
        return "Feedback của user ID " + userId + " đã được cập nhật.";
    }

    // 11. Quản lý bảng giá gói tiêm (chỉ dành cho staff)
    public String manageVaccinePackages(Object packageDetails) {
